      ...
      <section className="anim-fade-up bg-card border border-line rounded-lg shadow-paper" style={{animationDelay: '120ms'}}>
        ...
        <div className="px-6 py-5">
          <p className="text-[14px] ink-soft leading-relaxed mb-5">
            Pulls fresh match data from football-data.org, recalculates scores, and dispatches any pending notification emails (pool recaps every 3 days, deadline reminders, round recaps). Odds are left untouched.
          </p>
          <button
            onClick={handleSync}
            disabled={syncing}
